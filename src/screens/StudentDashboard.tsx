/**
 * Student dashboard with real API data: my courses, videos, notifications.
 */
...
export default function StudentDashboard() {
  ...
  const userName = dashboardData.user?.name || dashboardData.user?.email || 'Student';
  const enrolledCount = dashboardData.stats?.enrolled_courses || 0;
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.cardContent}>
            ...
            <Text style={styles.cardSub}>View enrolled courses</Text>
          </View>
        </TouchableOpacity>
        ...
        >
          ...
          <View style={styles.cardContent}>
            ...
            <Text style={styles.cardSub}>New lectures & assignments</Text>
          </View>
        </TouchableOpacity>
